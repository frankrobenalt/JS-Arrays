...
function divider (numbersArray) {
  ...
  for (var i = 0; i<numbersArray.length; i++) {
    if (numbersArray[i] % 2 === 0) {
      evenArr[0].push(numbersArray[i]);
    }
    else {
      evenArr[1].push(numbersArray[i]);
    }
  }
  return evenArr;
}
...
var user2 = {
  name: 'John Everwaldeagle',
  email: 'candyman@gmail.com',
  password: 'bigfellas',
  username: 'fahgetaboutit'
};
var user3 = {
  name: 'Sindy Grislyarms',
  email: 'sindysowindy@about.me',
  password: 'bigolsally',
  username: '42069'
}
users[0] = user1;
